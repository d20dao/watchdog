...
import { ingestReport } from "../src/store.js";
import { memoryStorage, sampleReport } from "./helpers.js";

const ENV = { HEALTH_KEY_ARC_TESTNET: "throwaway-testnet-key", HEALTH_KEY_ARC_MAINNET: "throwaway-mainnet-key" };

function setup() {
  const storage = memoryStorage();
  const counters = { status: 0, ingest: 0 };
  const stub = {
